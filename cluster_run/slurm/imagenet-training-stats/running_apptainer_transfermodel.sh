...
RESULT_STORAGE_DIR="/data/cluster/users/lweber/reward-backprop/imagenet-training-stats/"
...
apptainer run --nv \
              ...
              ../../singularity/image_mini.sif bash /mnt/reward-backprop/cluster_run/slurm/imagenet-training-stats/run.sh $fname_config
