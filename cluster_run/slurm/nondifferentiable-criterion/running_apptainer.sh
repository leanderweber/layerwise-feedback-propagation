...
RESULT_STORAGE_DIR="/data/cluster/users/lweber/reward-backprop/nondifferentiable-criterion/"
...
apptainer run --nv \
              ...
              ../../singularity/image_mini.sif bash /mnt/reward-backprop/cluster_run/slurm/nondifferentiable-criterion/run.sh $fname_config
