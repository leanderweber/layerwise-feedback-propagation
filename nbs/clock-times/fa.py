...
### Code copied from https://github.com/jordan-g/PyTorch-Feedback-Alignment-Layers/tree/master
...
class LinearFA(nn.Module):
    ...
    def __init__(self, in_features, out_features, bias=True):
        ...
        self.weight_fa = Parameter(torch.Tensor(out_features, in_features), requires_grad=False)
        if bias:
